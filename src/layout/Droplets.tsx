...
void main () {
  ...
  if (uHasContent < 0.5) {
    ...
    vec3 waterBase = vec3(0.96, 0.985, 1.0);
    vec3 dropCol = mix(waterBase, uTint, clamp(uTintStrength, 0.0, 1.0));
    vec3 colF = dropCol * (0.14 + 0.82 * rim) + vec3(spec * 1.45);
    float alphaF = mask * clamp(0.05 + rim * 0.48 + spec * 0.9, 0.0, 0.88);
